...
local handler_arr = {
    ...
    ["Messages.LoginAccountRequest"] = function(...) funs.login_req(...) end,
}
...
function funs.login_req(fd, msg)
    ...
    skynet.send("watchdog", "lua", "socket", "send", fd, 0, "Messages.LoginAccountResponse",  MsgLoginRsp)
end
